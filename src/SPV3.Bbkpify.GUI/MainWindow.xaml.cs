...
namespace SPV3.Bbkpify.GUI
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void LoadSapien(object sender, RoutedEventArgs e)
        {
            main.LoadSapien();
        }

        private void LoadBbkpify(object sender, RoutedEventArgs e)
        {
            main.LoadBbkpify();
        }

        private void LoadUnbbkpify(object sender, RoutedEventArgs e)
        {
            main.LoadUnbbkpify();
        }

        private void ConfigSapien(object sender, RoutedEventArgs e)
        {
            new SapienWindow(main).Show();
        }
        ...
        private void ChoosePlaceholder(object sender, RoutedEventArgs e)
        {
            ...
            if (placeholderDialog.ShowDialog() == true) main.Placeholder = placeholderDialog.FileName;
        }
